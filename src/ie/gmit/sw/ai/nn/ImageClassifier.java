...
public class ImageClassifier {
	...
	public ImageClassifier(String directory) throws Exception{
		...
		trainer.train(Utils.normalize(data, 0, 1), Utils.normalize(expected, 0, 1), 0.1, 10000);

		// Add the following to the constructor of the class ImageClassifier and to test if the
		// network is trained:
		int testIndex = 30;
